...
export default{
  ...
  data () {
    return {
      url:"http://39.106.40.235/ECate/front/user/register.shtml",
      username: "",
      code: "",
      password: "",
      password2: "",
  ...
  methods: {
    ...
    registerSubmit () {
      ...
      this.$api.post(this.url, {
        ...
        this.error['username'].bol = true
        this.error['username'].msg = res.msg
      })
    }
  }
}
...
<style src="~/style/scss/_register.scss"lang="scss"></style>